...
//void DebugGameObjectANDTileGameObject(const CollisionOccurence& occurence);
...
//  collisionMap_[std::make_pair(GameObjectNames::DebugGameObject, GameObjectNames::TileGameObject)] = DebugGameObjectANDTileGameObject;
//
...
//  //basic mtv move;
//  //moves debug game object away from tile game object
//  Transform& transformA = occurence.objectA_->GetParent()->GetTransform();
//
//  glm::vec2 oldPosition = transformA.GetPosition();
//
//  transformA.SetPosition(oldPosition + occurence.mtv_);
//}
//
//void PhysicsBodyGameObjectANDDebugGameObject(const CollisionOccurence& occurence)
//{
